...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71156133902149496)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50461765671724244)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50462304753724244)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50462736145724243)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50463290411724243)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50463786133724243)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50464233303724243)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50464753713724242)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50465299199724242)
,p_plug_template_id=>wwv_flow_imp.id(71156133902149496)
,p_name=>'Sub Regions'
