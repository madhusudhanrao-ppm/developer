...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71142595779149488)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50427247400724271)
,p_plug_template_id=>wwv_flow_imp.id(71142595779149488)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50427738475724271)
,p_plug_template_id=>wwv_flow_imp.id(71142595779149488)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50428292456724271)
,p_plug_template_id=>wwv_flow_imp.id(71142595779149488)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50428731924724271)
,p_plug_template_id=>wwv_flow_imp.id(71142595779149488)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50429248714724270)
,p_plug_template_id=>wwv_flow_imp.id(71142595779149488)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
