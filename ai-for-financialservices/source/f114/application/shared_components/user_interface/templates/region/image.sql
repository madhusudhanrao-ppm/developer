...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71146100864149491)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50434710749724266)
,p_plug_template_id=>wwv_flow_imp.id(71146100864149491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50435295429724266)
,p_plug_template_id=>wwv_flow_imp.id(71146100864149491)
,p_name=>'Sub Regions'
