...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(71116439605149471)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50359379013724324)
,p_plug_template_id=>wwv_flow_imp.id(71116439605149471)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50359899983724323)
,p_plug_template_id=>wwv_flow_imp.id(71116439605149471)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(50360355541724323)
,p_plug_template_id=>wwv_flow_imp.id(71116439605149471)
,p_name=>'Sub Regions'
