...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(71278632342149630)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1977969868564795521)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1977969313552795520)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1721077249822522007)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50733557622723822)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50734080190723820)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50734514068723819)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50735086668723819)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50735513747723817)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50736106720723816)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50736539332723814)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50735513747723817)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1977969868564795521)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50737028086723814)
,p_plugin_attribute_id=>wwv_flow_imp.id(50736539332723814)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50737666533723813)
,p_plugin_attribute_id=>wwv_flow_imp.id(50736539332723814)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50738273465723812)
,p_plugin_attribute_id=>wwv_flow_imp.id(50736539332723814)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50738873168723812)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50736539332723814)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50739241178723811)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50739775553723810)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50740280236723810)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50740720951723809)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50741247946723808)
,p_plugin_attribute_id=>wwv_flow_imp.id(50740720951723809)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50741826354723808)
,p_plugin_attribute_id=>wwv_flow_imp.id(50740720951723809)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50742452349723807)
,p_plugin_attribute_id=>wwv_flow_imp.id(50740720951723809)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50743068059723806)
,p_plugin_attribute_id=>wwv_flow_imp.id(50740720951723809)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50743676115723805)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(50736106720723816)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1977969313552795520)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50744194581723804)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50744701024723803)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50745147960723802)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50745707990723801)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50746182088723800)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50746667086723799)
,p_plugin_attribute_id=>wwv_flow_imp.id(50746182088723800)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50747245721723798)
,p_plugin_attribute_id=>wwv_flow_imp.id(50746182088723800)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50747815996723797)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50748375955723797)
,p_plugin_attribute_id=>wwv_flow_imp.id(50747815996723797)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50748949591723796)
,p_plugin_attribute_id=>wwv_flow_imp.id(50747815996723797)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50749555561723795)
,p_plugin_attribute_id=>wwv_flow_imp.id(50747815996723797)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50750121497723794)
,p_plugin_attribute_id=>wwv_flow_imp.id(50747815996723797)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50750761459723793)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50751289457723792)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50751857568723791)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50752419870723791)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50753021245723790)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50753620486723789)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50754286401723787)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50754861956723785)
,p_plugin_attribute_id=>wwv_flow_imp.id(50750761459723793)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50755451083723784)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50755931215723783)
,p_plugin_attribute_id=>wwv_flow_imp.id(50755451083723784)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50756563113723782)
,p_plugin_attribute_id=>wwv_flow_imp.id(50755451083723784)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50757164023723781)
,p_plugin_attribute_id=>wwv_flow_imp.id(50755451083723784)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50757801170723780)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50758214191723779)
,p_plugin_attribute_id=>wwv_flow_imp.id(50757801170723780)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50758834726723777)
,p_plugin_attribute_id=>wwv_flow_imp.id(50757801170723780)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50759498541723776)
,p_plugin_attribute_id=>wwv_flow_imp.id(50757801170723780)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50760088648723775)
,p_plugin_attribute_id=>wwv_flow_imp.id(50757801170723780)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50760698315723773)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50761200022723773)
,p_plugin_attribute_id=>wwv_flow_imp.id(50760698315723773)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50761766530723772)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50762227017723771)
,p_plugin_attribute_id=>wwv_flow_imp.id(50761766530723772)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50762834859723771)
,p_plugin_attribute_id=>wwv_flow_imp.id(50761766530723772)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50763418077723770)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50763994744723769)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50764480372723768)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1721077249822522007)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50764989044723767)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50765424399723766)
,p_plugin_attribute_id=>wwv_flow_imp.id(50764989044723767)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50766047003723765)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50766565718723764)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1879730342549042957)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1879731602069047105)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1562232243884858705)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866136713874636224)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1866816014604719328)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1879728407481997971)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1879729740872011828)
,p_plugin_id=>wwv_flow_imp.id(71278632342149630)
