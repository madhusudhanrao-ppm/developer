...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(71300959678149666)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1850795880382607378)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1850795325370607377)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50778608421723726)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50779047376723724)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50779520747723724)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50780040252723723)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50780543105723722)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50779520747723724)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1850795880382607378)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50781096793723721)
,p_plugin_attribute_id=>wwv_flow_imp.id(50780543105723722)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50781617780723721)
,p_plugin_attribute_id=>wwv_flow_imp.id(50780543105723722)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50782247113723720)
,p_plugin_attribute_id=>wwv_flow_imp.id(50780543105723722)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50782869581723719)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50780543105723722)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50783316177723719)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50783864171723718)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50784350395723717)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50784836486723717)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50785402661723716)
,p_plugin_attribute_id=>wwv_flow_imp.id(50784836486723717)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50785935418723715)
,p_plugin_attribute_id=>wwv_flow_imp.id(50784836486723717)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50786534265723714)
,p_plugin_attribute_id=>wwv_flow_imp.id(50784836486723717)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50787158326723713)
,p_plugin_attribute_id=>wwv_flow_imp.id(50784836486723717)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50787790222723712)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(50780040252723723)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1850795325370607377)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50788292856723711)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50788693692723710)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50789203940723710)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50789687340723709)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50790180756723708)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50790654312723707)
,p_plugin_attribute_id=>wwv_flow_imp.id(50790180756723708)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50791271380723706)
,p_plugin_attribute_id=>wwv_flow_imp.id(50790180756723708)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50791811598723705)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50792370072723705)
,p_plugin_attribute_id=>wwv_flow_imp.id(50791811598723705)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50792974791723704)
,p_plugin_attribute_id=>wwv_flow_imp.id(50791811598723705)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50793600816723703)
,p_plugin_attribute_id=>wwv_flow_imp.id(50791811598723705)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50794135941723702)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50794655254723701)
,p_plugin_attribute_id=>wwv_flow_imp.id(50794135941723702)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50795281615723700)
,p_plugin_attribute_id=>wwv_flow_imp.id(50794135941723702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50795868126723699)
,p_plugin_attribute_id=>wwv_flow_imp.id(50794135941723702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50796453441723698)
,p_plugin_attribute_id=>wwv_flow_imp.id(50794135941723702)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50797078490723697)
,p_plugin_attribute_id=>wwv_flow_imp.id(50794135941723702)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50797686284723695)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50798179260723694)
,p_plugin_attribute_id=>wwv_flow_imp.id(50797686284723695)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50798761894723693)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1871522466862179943)
,p_plugin_id=>wwv_flow_imp.id(71300959678149666)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
