...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(71251144225149575)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50687112228723972)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50687704566723969)
,p_plugin_attribute_id=>wwv_flow_imp.id(50687112228723972)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50688281645723967)
,p_plugin_attribute_id=>wwv_flow_imp.id(50687112228723972)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50688834707723966)
,p_plugin_attribute_id=>wwv_flow_imp.id(50687112228723972)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50689455847723964)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50687112228723972)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50690005874723963)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50690453369723961)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50690993188723960)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50691502986723959)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50692003063723959)
,p_plugin_attribute_id=>wwv_flow_imp.id(50691502986723959)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50692583725723958)
,p_plugin_attribute_id=>wwv_flow_imp.id(50691502986723959)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50693153194723956)
,p_plugin_attribute_id=>wwv_flow_imp.id(50691502986723959)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50693799773723955)
,p_plugin_attribute_id=>wwv_flow_imp.id(50691502986723959)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50694396434723954)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50694841139723953)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50695484842723952)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50696058802723951)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50696653721723948)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50697294412723947)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50697875440723946)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50698493017723944)
,p_plugin_attribute_id=>wwv_flow_imp.id(50694396434723954)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50699077105723943)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1871301920166263327)
,p_plugin_id=>wwv_flow_imp.id(71251144225149575)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
