...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(71268553331149620)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1850600725167755586)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50715999613723866)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50716412419723865)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50716951601723864)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50717433945723863)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50717917061723863)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50725117407723851)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1850600725167755586)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50718459287723862)
,p_plugin_attribute_id=>wwv_flow_imp.id(50717917061723863)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50719040241723861)
,p_plugin_attribute_id=>wwv_flow_imp.id(50717917061723863)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50719628915723860)
,p_plugin_attribute_id=>wwv_flow_imp.id(50717917061723863)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50720248266723859)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(50717917061723863)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50720803325723858)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50721274632723858)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50721720528723857)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50722275956723856)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50722716490723856)
,p_plugin_attribute_id=>wwv_flow_imp.id(50722275956723856)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50723341103723855)
,p_plugin_attribute_id=>wwv_flow_imp.id(50722275956723856)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50723940654723854)
,p_plugin_attribute_id=>wwv_flow_imp.id(50722275956723856)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50724545356723852)
,p_plugin_attribute_id=>wwv_flow_imp.id(50722275956723856)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50725117407723851)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50725635522723850)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50726141198723849)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50726659746723849)
,p_plugin_attribute_id=>wwv_flow_imp.id(50726141198723849)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(50727306169723848)
,p_plugin_attribute_id=>wwv_flow_imp.id(50726141198723849)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(50727881187723847)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1871286749033282839)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1871286157528275382)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1871341781198257261)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1871493998911128032)
,p_plugin_id=>wwv_flow_imp.id(71268553331149620)
