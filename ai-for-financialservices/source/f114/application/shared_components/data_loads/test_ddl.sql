...
wwv_flow_imp_shared.create_data_profile(
 p_id=>wwv_flow_imp.id(97163533266662884)
,p_name=>'test_ddl'
,p_format=>'CSV'
...
wwv_flow_imp_shared.create_data_profile_col(
 p_id=>wwv_flow_imp.id(97163795472662902)
,p_data_profile_id=>wwv_flow_imp.id(97163533266662884)
...
wwv_flow_imp_shared.create_load_table(
 p_id=>wwv_flow_imp.id(97163996773662903)
,p_name=>'test_ddl'
