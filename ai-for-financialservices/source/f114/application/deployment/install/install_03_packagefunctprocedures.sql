prompt --application/deployment/install/install_03_packagefunctprocedures
begin
--   Manifest
--     INSTALL: INSTALL-03_PackageFunctProcedures
--   Manifest End
...
wwv_flow_imp_shared.create_install_script(
 p_id=>wwv_flow_imp.id(9041661660075931)
,p_install_id=>wwv_flow_imp.id(85574615571926073)
,p_name=>'03_PackageFunctProcedures'
,p_sequence=>210
...
'    x_object_store_url := ''https://objectstorage.us-phoenix-1.oraclecloud.com/n/replace-this/b/replace-this/o/Speech/''||v_filename;   ',
' ',
...
'     ',
' ',
'    --v_planetext := ''Cancer is a complex group of diseases characterized by uncontrolled cell growth and division which can then invade and spread to other parts of the body It is a multifaceted disease that can affect any part of the body including'
||' organs tissues and even the blood Cancer is a leading cause of death worldwide and its impact extends beyond the physical symptoms as it can also have profound emotional psychological and social effects on individuals and their families At the core '
||'of cancers development is an alteration in the cells DNA Mutations or changes in the DNA can cause cells to grow out of control and divide uncontrollably leading to the formation of a tumor These abnormal cells can then invade nearby tissues and in s'
||'ome cases spread to other organs through a process known as metastasis There are over 100 types of cancer each with its unique characteristics and causes The most common types include breast lung colorectal prostate and skin cancer These types vary i'
||'n their causes risk factors and treatment approaches Some of the key risk factors associated with cancer include age genetic predisposition lifestyle choices such as smoking and unhealthy diets exposure to carcinogens and previous radiation exposure '
||'among others''; ',
...
'   ',
'  GC_WC_CREDENTIAL_ID        CONSTANT VARCHAR2(50)   := ''Ind_OCI_WebCred'';   ',
'  -- Old Model ocid1.aivisionmodel.oc1.phx.amaaaaaaknuwtjianuvt7rx6r6wdasaz5yp6cnyhhgzktzsvsvgeltvq7tza ',
'  -- New Model ocid1.aivisionmodel.oc1.phx.amaaaaaaknuwtjiaknai2cp5dioyg2f6rey4nahv6liheupktfthw3gakucq ',
' ',
'  --- Dynamic variables --------- ',
'  v_GC_OCI_OBJ_STORE_BASE_URL  MACHINE_LEARNING_CONFIGS.GC_OCI_OBJ_STORE_BASE_URL%TYPE; ',
'  v_GC_OCI_DOC_AI_URL          MACHINE_LEARNING_CONFIGS.GC_OCI_DOC_AI_URL%TYPE; ',
...
'    SELECT category into v_CATEGORY FROM ( select distinct catego'))
);
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(9041661660075931)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'ry  from RETAIL_SHOPPING  ORDER BY DBMS_RANDOM.RANDOM) WHERE  rownum < 2; ',
' ',
'        ',
'      v_which_country := round(DBMS_Random.Value(1,6),0); ',
...
wwv_flow_imp_shared.append_to_install_script(
 p_id=>wwv_flow_imp.id(9041661660075931)
,p_script_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'OL_NAME_TABLE(EDGE_TAB_NAMES(IDX1 - 1)) := DEST_EDGE_COL_NAME_FOR_EACH_EDGE;',
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9041765541075927)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
,p_object_name=>'ADD_TO_CART'
);
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9041922745075925)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9042107794075924)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9042387620075923)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9042559016075922)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9042711621075921)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9042908781075920)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9043122399075919)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9043368745075918)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9043554683075916)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9043743774075915)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9043922697075914)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9044162414075913)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9044365150075911)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9044526267075910)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9044740039075909)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9044934074075907)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9045133611075906)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9045343968075905)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9045553005075904)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9045779873075903)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9045930587075902)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9046125566075900)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9046353683075899)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'FUNCTION'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9046543759075898)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9046785803075897)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9046935178075896)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9047102225075895)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9047321832075894)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9047514139075893)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9047714677075892)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PACKAGE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9047906948075891)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9048183460075890)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9048381788075889)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9048541442075888)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9048771948075887)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9048944457075886)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9049192017075885)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9049366194075884)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9049514438075883)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9049798283075882)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
...
wwv_flow_imp_shared.create_install_object(
 p_id=>wwv_flow_imp.id(9049974595075881)
,p_script_id=>wwv_flow_imp.id(9041661660075931)
,p_object_owner=>'#OWNER#'
,p_object_type=>'PROCEDURE'
