...
'    g_key           constant varchar2(63) := apex_util.url_encode(''AIzaSyB8qFIC-dR1U1SyrF2Q-ysaYq83HtKs12s'');',
'    g_playlist_id   constant varchar2(63) := apex_util.url_encode(''PLPIzp-E1msraJ-9ToXZG5n03hf0ghnzDg'');',
'',
'',
'    procedure capture_stats',
'    is ',
