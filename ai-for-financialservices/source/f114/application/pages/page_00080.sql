...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(15950143971799010)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(15950570794799014)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(15950143971799010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15950273721799011)
,p_name=>'P80_EMAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(15950143971799010)
,p_prompt=>'Email'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_field_template=>wwv_flow_imp.id(71246683838149554)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15950377566799012)
,p_name=>'P80_QUESTION'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(15950143971799010)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15950404364799013)
,p_name=>'P80_ANSWER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(15950143971799010)
,p_prompt=>'Answer'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(15950690002799015)
,p_name=>'P80_NEW_PWD'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(15950143971799010)
,p_prompt=>'Message'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(15950740899799016)
...
,p_process_when_button_id=>wwv_flow_imp.id(15950570794799014)
