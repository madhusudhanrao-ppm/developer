...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(198920015683847511)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(198920093882847512)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198920191076847513)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198920356840847514)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198920539818847516)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198921359825847524)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198921380244847525)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198921804277847529)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(198922002939847531)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(199145672918762583)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(149596913905839298)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(199145774835762584)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(150137911147414008)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(150138064639414009)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(150138150451414010)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(150138234595414011)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(150138314397414012)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(150138480915414013)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(98205192450106953)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(98205293251106954)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(198960121306258454)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(99628995190357190)
,p_report_id=>wwv_flow_imp.id(198960121306258454)
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(99629356758357192)
,p_report_id=>wwv_flow_imp.id(198960121306258454)
,p_name=>'Approved Tx'
,p_condition_type=>'HIGHLIGHT'
,p_allow_delete=>'Y'
...
wwv_flow_imp_page.create_worksheet_condition(
 p_id=>wwv_flow_imp.id(99629768473357192)
,p_report_id=>wwv_flow_imp.id(198960121306258454)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(684659319269737490)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(684659354835737491)
,p_plug_name=>'Left Side'
,p_parent_plug_id=>wwv_flow_imp.id(684659319269737490)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(71109283471149467)
,p_plug_display_sequence=>10
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(684658939919737487)
,p_plug_name=>'Receipt'
,p_parent_plug_id=>wwv_flow_imp.id(684659354835737491)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(684659440958737492)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(98204961899106951)
,p_plug_name=>'Transaction'
,p_parent_plug_id=>wwv_flow_imp.id(684659440958737492)
,p_region_template_options=>'#DEFAULT#:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(71175863779149507)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(115544580885170786)
,p_plug_name=>'submit'
,p_parent_plug_id=>wwv_flow_imp.id(684659440958737492)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(120792327299116478)
,p_plug_name=>'New'
,p_parent_plug_id=>wwv_flow_imp.id(115544580885170786)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(71110656683149468)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(684657273189737470)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99605891815841064)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99605539610841064)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99605075339841064)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99604712754841063)
,p_query_column_id=>4
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99604314403841063)
,p_query_column_id=>5
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99603858528841062)
,p_query_column_id=>6
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99603506204841062)
,p_query_column_id=>7
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(684658530253737482)
,p_name=>'Field Labels'
,p_parent_plug_id=>wwv_flow_imp.id(684659440958737492)
,p_template=>wwv_flow_imp.id(71175863779149507)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99602709269841061)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99602261971841061)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(99601900977841060)
,p_query_column_id=>3
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(99600394736841058)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_imp.id(115544580885170786)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(120794259877116483)
,p_name=>'P21_TY'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(115544580885170786)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(684665359355737480)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(99607550869841066)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(99600394736841058)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(99608620816841069)
,p_event_id=>wwv_flow_imp.id(99607550869841066)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(99608129100841068)
,p_event_id=>wwv_flow_imp.id(99607550869841066)
,p_event_result=>'TRUE'
