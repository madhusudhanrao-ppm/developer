...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(25974341806208805)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25974057984208802)
,p_name=>'P105_PGNO'
,p_item_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(25974163659208803)
,p_name=>'P105_PGHTML'
,p_item_sequence=>20
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(25974458210208806)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(25974341806208805)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(25974579988208807)
,p_event_id=>wwv_flow_imp.id(25974458210208806)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(25974638062208808)
,p_event_id=>wwv_flow_imp.id(25974458210208806)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(25969754684261978)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(25974295632208804)
