...
| - |  Transaction Anomalies |  - | Anomaly Detection AI Service <br/> Graphs | [Lab 16](../workshops/tenancy/index.html?lab=ai-fs-anti-money-laundering) | Complete |  
...
| Retail online purchase |  - | - | Oracle Database 23ai & PL/SQL <br/>Realtime Dashboard Oracle APEX <br/> Bulk Data Upload <br/> Meta Llama Vision Instruct <br/> Speech AI (Text to Speech)  | [Lab 18](../workshops/tenancy/index.html?lab=ai-fs-retail) | - |
|   AI Search - (LLM) | AI Search - (DB+LLM+KM)+  | - | Oracle Database 23ai <br/>Select AI & AI Vector Search <br/>AI Services <br/>RAG with Gen AI (Cohere)  | [Lab 19](../workshops/tenancy/index.html?lab=ai-fs-search) | - |
