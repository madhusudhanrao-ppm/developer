...
* You have an Oracle Cloud account with OCI and Tenancy administration privileges to create policies and compartments. 
    ...
    <br/>
    > **Note 2:**  If there are any policies missing, please check the [OCI Common Policies](https://docs.oracle.com/en-us/iaas/Content/Identity/Concepts/commonpolicies.htm) 
...
1. Create a new policy with the following statements:
    ...
    allow any-user to manage tag-namespaces in tenancy
    allow any-user to manage ons-family in tenancy
    ...
    allow any-user to manage ons-family in tenancy
    allow any-user to manage cloudevents-rules in tenancy
    allow any-user to manage to use virtual-network-family in tenancy
    allow any-user to manage to manage function-family in tenancy
    </copy>
    ```
