...
3. Apply Business logic on generated transactions to detect fraud
4. Update Transactions when the Scheduler Job starts
...
5. Lets apply business logic for each transaction row, rather than all rows together 
